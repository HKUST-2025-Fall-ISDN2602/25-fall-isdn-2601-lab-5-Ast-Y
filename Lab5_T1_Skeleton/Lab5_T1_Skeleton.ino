...
#define A  23 // Replace the ? with the GPIO pin you selected to connect encoder A
#define B  22 // Replace the ? with the GPIO pin you selected to connect encoder B
