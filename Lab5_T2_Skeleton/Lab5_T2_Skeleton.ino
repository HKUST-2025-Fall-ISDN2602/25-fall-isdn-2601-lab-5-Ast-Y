...
#define AL  23 // Replace the ? with the GPIO pin you selected to connect encoder A of Motor L
#define BL  22 // Replace the ? with the GPIO pin you selected to connect encoder B of Motor L

#define IN3   25  // Replace the ? with the GPIO pin you selected to connect IN3
#define IN4   26   // Replace the ? with the GPIO pin you selected to connect IN4
#define AR  18 // Replace the ? with the GPIO pin you selected to connect encoder A of Motor R
#define BR 19 // Replace the ? with the GPIO pin you selected to connect encoder B of Motor R
